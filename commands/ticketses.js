...
module.exports.run = async (client, message, args) => {
    ...
    message.guild.createChannel(`ticket-${message.author.tag}`, "voice").then(c => {
        ...
        message.reply(`   Başvurunuz oluşturuldu <@&664149550633844738> :  #${c.name}.`);
        c.send(`Bilet açtığınız için teşekkürler! Nasıl yardımcı olabiliriz? \n   <@&664149550633844738> `);
